...
(function() {
  ...
  Application = (function() {
    ...
    function Application(env, callback) {
      if (_.isFunction(env) === true) {
        callback = env;
        env = null;
      }
      if (this.ENV === env || _.isNull(env)) {
    ...
    Application.put = function(key, value) {
      var config;
      config = key;
    ...
    Application.get = function(key, alt) {
      if (alt == null) {
        alt = null;
      }
    ...
    Application.bind = function(name, instance) {
      return this.instances[name] = instance;
    };

    Application.resolve = function(name) {
      var base;
    ...
    Application.make = function(name) {
      var base, options;
