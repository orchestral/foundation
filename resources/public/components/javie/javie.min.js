...
r.isObject(n)||(n={},n[e]=t),this.config=r.defaults(n,this.config),this},e.prototype.on=function(e,t){var n;return n=this.instances.event,n.listen(e,t),
this},e.prototype.trigger=function(e,t){var n;return n=this.instances.event,n.fire(e,t),this},e.prototype.bind=function(e,t){return this.instances[e]=t,
this},e.prototype.make=function(e){var o,i;return i=t(arguments),e=i.shift(),o=this.resolve(e),r.isFunction(o)?o.apply(n,i):o},e.prototype.resolve=function(e){
var t;return t=this.instances[e],r.isUndefined(t)?null:t},e.prototype.when=function(e,t){var n;return null!=this.ENV&&(n=this.ENV),null!=this.environment&&(n=this.environment),
n===e||"*"===e?this.run(t):void 0},e.prototype.run=function(e){return r.isFunction(e)?e.call(this):void 0},e}(),n.Javie=new e}).call(this),function(){var e,t,n,r,o,i;
if(n=null,r={},o="undefined"!=typeof exports&&null!==exports?exports:this,i=o._,i||"undefined"==typeof require||null===require||(i=require("underscore")),
...
}.call(this),function(){var e,t;t=this,e=t.Javie,e.bind("underscore",function(){return t._}),e.bind("event",function(){return new e.EventDispatcher}),e.bind("profiler",function(t){
