...
var t=this.make("event");return t.listen(e,n),this}},{key:"emit",value:function(e){var n=void 0===arguments[1]?[]:arguments[1],t=this.make("event");return t.fire(e,n),
this}},{key:"trigger",value:function(e){var n=void 0===arguments[1]?[]:arguments[1];return this.emit(e,n)}},{key:"bind",value:function(e,n){return this.instances[e]=new l(e,n),
this}},{key:"make",value:function(e){var n=a.array_make(arguments);return e=n.shift(),this.instances[e]instanceof l?this.instances[e].resolving(n):void 0;
}},{key:"singleton",value:function(e,n){return this.instances[e]=new l(e,n,!0),this}},{key:"when",value:function(e,n){var t=this.environment;return t===e||"*"==e?this.run(n):void 0;
}},{key:"run",value:function(e){return s.isFunction(e)?e.call(this):void 0}}]),e}();t["default"]=f,n.exports=t["default"]},{"./helpers":3,"./vendor/underscore":9
}],3:[function(e,n,t){"use strict";function r(e){return Array.prototype.slice.call(e)}function u(){var e=void 0===arguments[0]?!0:arguments[0],n=(new Date).getTime(),t=parseInt(n/1e3,10),r=(n-1e3*t)/1e3+" sec";
...
"default":e}}function u(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(t,"__esModule",{value:!0
});var i=function(){function e(e,n){for(var t=0;t<n.length;t++){var r=n[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),
Object.defineProperty(e,r.key,r)}}return function(n,t,r){return t&&e(n.prototype,t),r&&e(n,r),n}}(),o=e("../../vendor/underscore"),a=r(o),s=null,l={},f=function(){
